export const ExperienceData = [
  ...
  },
  {
    ...
    comment: ["I enjoyed cooperating with a relatively large (6 people) on a hackerthon that emphasised the idea and design as much as the programming project.",
              "My first experience with dealing with struggles with integration of parts of a multifaceted project.",
  ...
  },
  {
    ...
    description: "A team hackerthon by Google, oriented on problem solving and algorithms. My first hackerthon.",
    comment: ["Me and my team woke up at 3 am to compete.",
